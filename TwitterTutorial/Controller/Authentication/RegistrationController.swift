...
class RegistrationController: UIViewController {
    ...
    private lazy var fullnameContainerView: UIView = {
        let imagem = #imageLiteral(resourceName: "ic_person_outline_white_2x")
        let view = Utilities().inputContainerView(withImage: imagem, textField: fullnameTextField)
        return view
    }()
    
    private lazy var usernameContainerView: UIView = {
        let imagem = #imageLiteral(resourceName: "ic_person_outline_white_2x")
        let view = Utilities().inputContainerView(withImage: imagem, textField: usernameTextField)
        return view
    }()
    ...
    func configureUI() {
        ...
        stack.anchor(top: plusPhotoButton.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 32, paddingLeft: 32, paddingRight: 32)
            ...
            view.addSubview(alreadyHaveAccontButton)
               alreadyHaveAccontButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor,
